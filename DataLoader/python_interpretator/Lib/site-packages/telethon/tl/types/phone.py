...
if TYPE_CHECKING:
    from ...tl.types import TypeGroupCall, TypeGroupCallParticipant, TypePhoneCall, TypeUser



class GroupCall(TLObject):
    CONSTRUCTOR_ID = 0x66ab0bfc
    SUBCLASS_OF_ID = 0x304116be

    def __init__(self, call: 'TypeGroupCall', participants: List['TypeGroupCallParticipant'], participants_next_offset: str, users: List['TypeUser']):
        """
    ...
    def from_reader(cls, reader):
        ...
        return cls(call=_call, participants=_participants, participants_next_offset=_participants_next_offset, users=_users)


class GroupParticipants(TLObject):
    CONSTRUCTOR_ID = 0x9cfeb92d
    SUBCLASS_OF_ID = 0x72d304f4

    def __init__(self, count: int, participants: List['TypeGroupCallParticipant'], next_offset: str, users: List['TypeUser'], version: int):
        """
    ...
    def from_reader(cls, reader):
        ...
        return cls(count=_count, participants=_participants, next_offset=_next_offset, users=_users, version=_version)
