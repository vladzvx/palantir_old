...
_USERINFO = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='Phone', full_name='snapshot.UserInfo.Phone', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='SessionName', full_name='snapshot.UserInfo.SessionName', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='GetFullChannelCounter', full_name='snapshot.UserInfo.GetFullChannelCounter', index=2,
...
_CONFIGURATIONCONTAINER.fields_by_name['UserParams'].message_type = _USERINFO
...
UserInfo = _reflection.GeneratedProtocolMessageType('UserInfo', (_message.Message,), {
  ...
  '__module__' : 'Configurator_pb2'
  # @@protoc_insertion_point(class_scope:snapshot.UserInfo)
  })
